...
void Skybox::loadCubemap(const std::vector<std::string>& faces) {
    ...
    // Create staging buffer (implementation omitted for brevity, assuming helper exists or inline)
    // For now, let's just use a simplified version or assume createBuffer exists in Renderer and we can't access it easily here without passing it.
    // We'll implement a local createBuffer for now.
